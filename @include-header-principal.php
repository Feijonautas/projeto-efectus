...
<script>
	$(document).ready(function(){
		$(".menu-mobile").off().on("click", function(){
			$(".links-principais").slideToggle();
			$(".links-principais .sub-links").css("display", "none");
		});
		$(".links-principais #drop").click(function(){
			$(".links-principais .sub-links").slideUp();
...
<header>
	...
	<nav class="main-nav">
		...
		<ul class="links-principais">
			...
			<li id="drop"><a href="marketing.php" class="link-principal">Marketing<i class="fas fa-caret-down"></i></a>
				<ul class="sub-links">
